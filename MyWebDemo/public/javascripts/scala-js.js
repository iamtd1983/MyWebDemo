...
/** @constructor */
ScalaJS.c.LScalaJSExample$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.LScalaJSExample$.prototype = new ScalaJS.h.O();
ScalaJS.c.LScalaJSExample$.prototype.constructor = ScalaJS.c.LScalaJSExample$;
/** @constructor */
ScalaJS.h.LScalaJSExample$ = (function() {
  /*<skip>*/
});
ScalaJS.h.LScalaJSExample$.prototype = ScalaJS.c.LScalaJSExample$.prototype;
ScalaJS.c.LScalaJSExample$.prototype.init___ = (function() {
  ScalaJS.n.LScalaJSExample = this;
  return this
});
ScalaJS.c.LScalaJSExample$.prototype.main__V = (function() {
  ScalaJS.g["document"]["getElementById"]("scalajsShoutOut")["textContent"] = "aaa"
});
ScalaJS.c.LScalaJSExample$.prototype.$$js$exported$meth$main__O = (function() {
  return (this.main__V(), (void 0))
});
ScalaJS.c.LScalaJSExample$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
ScalaJS.is.LScalaJSExample$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LScalaJSExample$)))
});
ScalaJS.as.LScalaJSExample$ = (function(obj) {
  return ((ScalaJS.is.LScalaJSExample$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "ScalaJSExample$"))
});
ScalaJS.isArrayOf.LScalaJSExample$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LScalaJSExample$)))
});
ScalaJS.asArrayOf.LScalaJSExample$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.LScalaJSExample$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "LScalaJSExample$;", depth))
});
ScalaJS.d.LScalaJSExample$ = new ScalaJS.ClassTypeData({
  LScalaJSExample$: 0
}, false, "ScalaJSExample$", ScalaJS.d.O, {
  LScalaJSExample$: 1,
  sjs_js_JSApp: 1,
  O: 1
});
ScalaJS.c.LScalaJSExample$.prototype.$classData = ScalaJS.d.LScalaJSExample$;
ScalaJS.n.LScalaJSExample = (void 0);
ScalaJS.m.LScalaJSExample = (function() {
  if ((!ScalaJS.n.LScalaJSExample)) {
    ScalaJS.n.LScalaJSExample = new ScalaJS.c.LScalaJSExample$().init___()
  };
  return ScalaJS.n.LScalaJSExample
});
ScalaJS.e["ScalaJSExample"] = ScalaJS.m.LScalaJSExample;
/** @constructor */
...
/** @constructor */
ScalaJS.c.LmyScalaJs$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.LmyScalaJs$.prototype = new ScalaJS.h.O();
ScalaJS.c.LmyScalaJs$.prototype.constructor = ScalaJS.c.LmyScalaJs$;
/** @constructor */
ScalaJS.h.LmyScalaJs$ = (function() {
  /*<skip>*/
});
ScalaJS.h.LmyScalaJs$.prototype = ScalaJS.c.LmyScalaJs$.prototype;
ScalaJS.c.LmyScalaJs$.prototype.init___ = (function() {
  ScalaJS.n.LmyScalaJs = this;
  return this
});
ScalaJS.c.LmyScalaJs$.prototype.main__V = (function() {
  ScalaJS.protect(ScalaJS.g["jQuery"])("a.delete")["click"]((function(f) {
    return (function(arg1, arg2) {
      var e = arg1;
      var obj = arg2;
      if (ScalaJS.uZ(ScalaJS.g["confirm"]("Are you sure to delete this?"))) {
        var href = ScalaJS.as.T(ScalaJS.protect(ScalaJS.g["jQuery"])(obj)["attr"]("href"));
        ScalaJS.g["alert"](href);
        ScalaJS.g["console"]["log"](href);
        ScalaJS.g["jQuery"]["ajax"]({
          "url": href,
          "success": (function(data$2, textStatus$2, jqXHR$2) {
            ScalaJS.as.T(textStatus$2);
            var qual$1 = ScalaJS.g["document"]["location"];
            qual$1["reload"]()
          }),
          "type": "DELETE"
        })
  ...
  })(new ScalaJS.c.LmyScalaJs$$anonfun$main$1().init___()))
});
ScalaJS.c.LmyScalaJs$.prototype.displayUserNumber__V = (function() {
  var userCount = ScalaJS.uI(ScalaJS.protect(ScalaJS.g["jQuery"])(".user")["length"]);
  ScalaJS.protect(ScalaJS.g["jQuery"])("#userNumber")["html"]((("There is " + userCount) + " users now."))
});
ScalaJS.c.LmyScalaJs$.prototype.$$js$exported$meth$main__O = (function() {
  return (this.main__V(), (void 0))
});
ScalaJS.c.LmyScalaJs$.prototype.$$js$exported$meth$displayUserNumber__O = (function() {
  return (this.displayUserNumber__V(), (void 0))
});
ScalaJS.c.LmyScalaJs$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
ScalaJS.c.LmyScalaJs$.prototype["displayUserNumber"] = (function() {
  return this.$$js$exported$meth$displayUserNumber__O()
});
ScalaJS.is.LmyScalaJs$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LmyScalaJs$)))
});
ScalaJS.as.LmyScalaJs$ = (function(obj) {
  return ((ScalaJS.is.LmyScalaJs$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "myScalaJs$"))
});
ScalaJS.isArrayOf.LmyScalaJs$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LmyScalaJs$)))
});
ScalaJS.asArrayOf.LmyScalaJs$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.LmyScalaJs$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "LmyScalaJs$;", depth))
});
ScalaJS.d.LmyScalaJs$ = new ScalaJS.ClassTypeData({
  LmyScalaJs$: 0
}, false, "myScalaJs$", ScalaJS.d.O, {
  LmyScalaJs$: 1,
  sjs_js_JSApp: 1,
  O: 1
});
ScalaJS.c.LmyScalaJs$.prototype.$classData = ScalaJS.d.LmyScalaJs$;
ScalaJS.n.LmyScalaJs = (void 0);
ScalaJS.m.LmyScalaJs = (function() {
  if ((!ScalaJS.n.LmyScalaJs)) {
    ScalaJS.n.LmyScalaJs = new ScalaJS.c.LmyScalaJs$().init___()
  };
  return ScalaJS.n.LmyScalaJs
});
ScalaJS.e["myScalaJs"] = ScalaJS.m.LmyScalaJs;
...
ScalaJS.c.sr_AbstractFunction2.prototype.init___ = (function() {
  return this
});
...
/** @constructor */
ScalaJS.c.LmyScalaJs$$anonfun$main$1 = (function() {
  ScalaJS.c.sr_AbstractFunction2.call(this)
});
ScalaJS.c.LmyScalaJs$$anonfun$main$1.prototype = new ScalaJS.h.sr_AbstractFunction2();
ScalaJS.c.LmyScalaJs$$anonfun$main$1.prototype.constructor = ScalaJS.c.LmyScalaJs$$anonfun$main$1;
/** @constructor */
ScalaJS.h.LmyScalaJs$$anonfun$main$1 = (function() {
  /*<skip>*/
});
ScalaJS.h.LmyScalaJs$$anonfun$main$1.prototype = ScalaJS.c.LmyScalaJs$$anonfun$main$1.prototype;
ScalaJS.is.LmyScalaJs$$anonfun$main$1 = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.LmyScalaJs$$anonfun$main$1)))
});
ScalaJS.as.LmyScalaJs$$anonfun$main$1 = (function(obj) {
  return ((ScalaJS.is.LmyScalaJs$$anonfun$main$1(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "myScalaJs$$anonfun$main$1"))
});
ScalaJS.isArrayOf.LmyScalaJs$$anonfun$main$1 = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.LmyScalaJs$$anonfun$main$1)))
});
ScalaJS.asArrayOf.LmyScalaJs$$anonfun$main$1 = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.LmyScalaJs$$anonfun$main$1(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "LmyScalaJs$$anonfun$main$1;", depth))
});
ScalaJS.d.LmyScalaJs$$anonfun$main$1 = new ScalaJS.ClassTypeData({
  LmyScalaJs$$anonfun$main$1: 0
}, false, "myScalaJs$$anonfun$main$1", ScalaJS.d.sr_AbstractFunction2, {
  LmyScalaJs$$anonfun$main$1: 1,
  s_Serializable: 1,
  Ljava_io_Serializable: 1,
  sr_AbstractFunction2: 1,
  F2: 1,
...
ScalaJS.c.LmyScalaJs$$anonfun$main$1.prototype.$classData = ScalaJS.d.LmyScalaJs$$anonfun$main$1;
